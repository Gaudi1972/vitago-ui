...
> = {
  Bajar: {
    green: {
      '+': "Estás en un rango óptimo de grasas. Mantienes energía sin excederte.",
      '-': "Ingesta correcta de grasas. Ideal para sostener funciones metabólicas en déficit.",
    },
    amber: {
      '+': "Algo por encima del objetivo. Podría dificultar el déficit calórico.",
      '-': "Algo por debajo. Podrías sentir fatiga o falta de saciedad.",
    },
    red: {
      '+': "Exceso de grasa. Dificulta la pérdida de peso y puede afectar salud cardiovascular.",
      '-': "Déficit importante. Riesgo de desequilibrio hormonal o baja energía.",
    },
  },
  Subir: {
    green: {
      '+': "Buen aporte de grasas. Aporta energía y favorece funciones hormonales.",
      '-': "Nivel correcto de grasas. Apoya ganancia muscular sin excesos.",
    },
    amber: {
      '+': "Algo elevado. Vigila que no desplace otros nutrientes clave.",
      '-': "Algo bajo. Aumenta grasas saludables como aguacate o frutos secos.",
    },
    red: {
      '+': "Muy alto. Riesgo de ganancia excesiva de grasa corporal.",
      '-': "Muy bajo. Puede afectar rendimiento y salud hormonal.",
    },
  },
  Mantener: {
    green: {
      '+': "Rango saludable. Buen balance para mantener peso y energía.",
      '-': "Nivel adecuado. Suficiente para funciones vitales.",
    },
    amber: {
      '+': "Algo por encima. Revisa si proviene de fuentes saludables.",
      '-': "Algo por debajo. Podría afectar tu saciedad o vitalidad.",
    },
    red: {
      '+': "Demasiada grasa. Posible ganancia de peso si no se ajusta.",
      '-': "Muy poca grasa. Riesgo de alteraciones hormonales o fatiga.",
    },
  },
  Recomposicion: {
    green: {
      '+': "Buen rango. Permite recomposición sin comprometer energía ni salud.",
      '-': "Buen nivel para sostener metabolismo mientras mejoras composición.",
    },
    amber: {
      '+': "Algo alto. Vigila si notas estancamiento en tus resultados.",
      '-': "Algo bajo. Puedes notar fatiga o dificultad para rendir.",
    },
    red: {
      '+': "Muy por encima del rango. Puede frenar tu progreso.",
      '-': "Muy por debajo. Riesgo de bajón energético o hormonal.",
    },
  },
  Rendimiento: {
    green: {
      '+': "Buen nivel de grasas. Soporta entrenamientos y recuperación.",
      '-': "Nivel adecuado. Proporciona energía sostenida.",
    },
    amber: {
      '+': "Estás algo por encima. Revisa el tipo de grasa que consumes.",
      '-': "Estás algo por debajo. Aumenta grasas buenas si te falta energía.",
    },
    red: {
      '+': "Exceso importante. Puede afectar digestión y rendimiento.",
      '-': "Muy bajo. Posible pérdida de fuerza o resistencia.",
    },
  },
};
...
// ✅ Función para generar comentario personalizado por nutriente
